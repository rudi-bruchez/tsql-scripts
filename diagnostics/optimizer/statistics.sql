...
-- AND stat.object_id = OBJECT_ID('<TABLE NAME>')   -- uncomment this line if you want to target a specific table
-- AND stat.name LIKE '_WA_Sys_%'   -- uncomment this line if you want to analyze only auto statistics
